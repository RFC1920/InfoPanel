...
namespace Oxide.Plugins
{
    ...
    public class InfoPanel : RustPlugin
    {
                    ...
                    { "TopLeftDock", new DockConfig
                        {
                            ...
                            AnchorX = "Left",
                            AnchorY = "Top",
                            Margin = "0.005 0.190 0.005 0.005",
                            BackgroundColor = "0 0 0 0.4",
                        }
                    },
                    ...
                    { "ChinookEvent", new PanelConfig
                        {
                            ...
                            Image = new PanelImageConfig
                            {
                                ...
                                Height = 0.8f,
                                Margin = "0 0.15 0.1 0.1",
                                Url = "https://i.imgur.com/b2YUQPQ.png",
                            },
                            PanelSettings = new Dictionary<string,object>
                            {
                                { "InactiveColor", "1 1 1 0.1" },
                                { "ActiveColor", "0.5 0.2 0.2 1" },
                            }
                    ...
                    { "BradleyEvent", new PanelConfig
                        {
                            ...
                            Image = new PanelImageConfig
                            {
                                ...
                                Height = 0.8f,
                                Margin = "0 0.15 0.1 0.1",
                                Url = "https://i.imgur.com/21V0yPs.png",
                            },
                            PanelSettings = new Dictionary<string,object>
                            {
                                { "InactiveColor", "1 1 1 0.1" },
        ...
        private void OnEntitySpawned(BaseEntity Entity)
        {
            ...
            if (Entity is BradleyAPC && Settings.Panels["BradleyEvent"].Available)
            {
